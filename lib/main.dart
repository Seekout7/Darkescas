...
'Yanginda kul olan kuklanin golgesi. Kameralar onu asla kaydedemez; sadece hissedersin.'),
CD('Fare', 0xFF4DB6AC, 3.4, 12, 'ventrush', 'vent',
'Havalandirma borularinda yasayan ilk prototip. Borularin icini avucu gibi bilir.'),
CD('Kas', 0xFFE57373, 2.9, 16, 'doorbreak', 'door',
'Fabrikanin eski maskot ayisi. Gece kapilari yumruklayan o; yavas ama durdurulamaz.'),
CD('Hacker', 0xFF64B5F6, 3.1, 15, 'camjam', 'quiet',
'Servis robotuydu; bir gece kameralari kendi kendine kapatmaya basladi. Kimse kodunu cozemedi.'),
CD('Isik', 0xFFFFD54F, 3.2, 13, 'lightimmune', 'light',
'Sahne isiklarinin altinda eridi. Artik fenerden korkmuyor; isik ona dokunamiyor.'),
CD('Gurultucu', 0xFFA1887F, 3.3, 11, 'noise', 'none',
'Cocuk partilerinin hoparloruydu. Simdi sahte seslerle guvenlikleri yanlis odaya kandiriyor.'),
CD('Korku', 0xFF7986CB, 3.0, 17, 'fear', 'none',
'Korku evi palyacasinin parcalarindan kuruldu. Bir bakisi gardiyanin ellerini 3 saniye titretebilir.'),
CD('Dalga', 0xFF81C784, 3.5, 9, 'dash', 'speed',
'Su parkindan getirilen eski maskot. Goz acip kapayana kadar yaninda biter.'),
CD('Enerji', 0xFFF06292, 3.0, 14, 'drain', 'none',
'Jenerator odasinda sarj olan ilk model. Ofise sizarsa gucunu damar damar emer.'),
];
}
MD mkMap(int i) {
if (i == 1) {
...
fontFamily: 'monospace')),
SizedBox(height: 6),
Text('GUVENLIK: Sadece ofisi gorursun. Animatronikleri yalnizca KAMERADAN izlersin. Kapi isigi + kapi + guc yonetimi. Saat 6 AM olana kadar dayan.',
style: TextStyle(fontSize: 11, color: Colors.white70)),
SizedBox(height: 4),
Text('ANIMATRONIK: Kendi bolgende gezersin, ofise sizarsin, guvenligi yakalarsin.',
style: TextStyle(fontSize: 11, color: Colors.white70)),
SizedBox(height: 4),
...
SizedBox(height: 8),
Text('Gece vardiyasina kalan son kisi. Kameralarin arkasinda, karanlik koridorlarin onunde tek basina.',
style: TextStyle(
fontSize: 11,
color: Colors.grey,
